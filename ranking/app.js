...
(function () {
    ...
    function renderRanking(data) {
        ...
        data.forEach((row, i) => {
            ...
            el.innerHTML = `
                ...
                <div class="tl-meta">
                    <span class="tl-dept">${escHtml((_a = row.department) !== null && _a !== void 0 ? _a : "—")}</span>
    ...
    async function loadMonth(monthObj) {
        ...
        try {
            ...
            const e = err;
            const tableMissing = (e === null || e === void 0 ? void 0 : e.code) === "42P01" ||
                /does not exist|undefined_table|schema cache/i.test((_a = e === null || e === void 0 ? void 0 : e.message) !== null && _a !== void 0 ? _a : "");
            if (tableMissing) {
