...
;(function () {
  ...
  function renderMonths(submittedByMonth) {
    ...
    MONTHS.forEach(function (key) {
      ...
      btn.addEventListener("click", function () {
        ...
        selectedMonth = key
        Array.prototype.forEach.call(monthsEl.querySelectorAll(".chip"), function (c) {
          c.setAttribute("aria-pressed", c.dataset.month === key ? "true" : "false")
        })
        renderDeadline()
        renderConfirm()
        loadIdentity()
  ...
  function showRejected(payload) {
    ...
    resultCard(
      '<div class="notice err">' + esc(receipt.errorText(payload.error)) + "</div>" +
  ...
  submitButton.addEventListener("click", function () {
    ...
    putObject(objectPath, pickedFile, function (frac) {
