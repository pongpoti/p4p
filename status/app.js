...
const main = async () => {
    ...
    try {
        ...
        if (supaResp.error)
            throw new Error("Supabase: " + supaResp.error.message);
        ...
        const pendingSummary = pending.querySelector("summary");
        ...
        for (const e of pendingEntries)
            tbody_pending.appendChild(makeRow(e.fullname, e.department, false));
        for (const e of sentEntries)
            tbody_sent.appendChild(makeRow(e.fullname, e.department, true));
